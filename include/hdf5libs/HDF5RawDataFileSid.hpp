...
#ifndef HDF5LIBS_INCLUDE_HDF5LIBS_HDF5RAWDATAFILESID_HPP_
#define HDF5LIBS_INCLUDE_HDF5LIBS_HDF5RAWDATAFILESID_HPP_
...
/**
 * @brief HDF5RawDataFileSid is the class responsible
 * for interfacing the DAQ format with the HDF5 file format.
 */
class HDF5RawDataFileSid
{
...
public:
  ...
  HDF5RawDataFileSid(std::string file_name,
...
private:
  ...
  HDF5RawDataFileSid& operator=(const HDF5RawDataFileSid&) = delete;
  HDF5RawDataFileSid(HDF5RawDataFileSid&&) = delete;
  HDF5RawDataFileSid& operator=(HDF5RawDataFileSid&&) = delete;
...
template<typename T>
void
HDF5RawDataFileSid::write_attribute(std::string name, T value)
{
...
template<typename T>
void
HDF5RawDataFileSid::write_attribute(HighFive::Group& grp, const std::string& name, T value)
{
...
template<typename T>
void
HDF5RawDataFileSid::write_attribute(HighFive::DataSet& dset, const std::string& name, T value)
{
...
template<typename T>
T
HDF5RawDataFileSid::get_attribute(const std::string& name)
{
  if (!m_file_ptr->hasAttribute(name)) {
...
template<typename T>
T
HDF5RawDataFileSid::get_attribute(const HighFive::Group& grp, const std::string& name)
{
  if (!(grp.hasAttribute(name))) {
    throw InvalidHDF5Attribute(ERS_HERE, name);
  }
...
template<typename T>
T
HDF5RawDataFileSid::get_attribute(const HighFive::DataSet& dset, std::string name)
{
  if (!dset.hasAttribute(name)) {
    throw InvalidHDF5Attribute(ERS_HERE, name);
  }
...
#endif // HDF5LIBS_INCLUDE_HDF5LIBS_HDF5RAWDATAFILESID_HPP_

...
public:
                                        ...
                                        daqdataformats::sequence_number_t seq_num=0) const
  {
    ...
    trigger_number_string << m_conf_params.trigger_record_name_prefix
			  << std::setw(m_conf_params.digits_for_trigger_number) 
			  << std::setfill('0') << trig_num;
    
    if (m_conf_params.digits_for_sequence_number > 0) {
       trigger_number_string << "." << std::setw(m_conf_params.digits_for_sequence_number) 
			     << std::setfill('0') << seq_num;
       }
  ...
  std::string get_trigger_record_header_path(daqdataformats::trigger_number_t trig_num,
					     daqdataformats::sequence_number_t seq_num = 0) const
  {
    return std::string(get_trigger_number_string(trig_num,seq_num)+"/"+m_conf_params.trigger_record_header_dataset_name);
  }
 				...
 				daqdataformats::sequence_number_t seq_num = 0) const
  {
    ...
    path_string << get_trigger_number_string(trig_num,seq_num) << "/"
		...
		<< path_params.region_name_prefix
		<< std::setw(path_params.digits_for_region_number)
		<< std::setfill('0') << element_id.region_id << "/"
		<< path_params.element_name_prefix
		<< std::setw(path_params.digits_for_element_number)
		<< std::setfill('0') << element_id.element_id;

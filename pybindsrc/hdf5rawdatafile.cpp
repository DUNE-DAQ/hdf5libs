...
register_hdf5rawdatafile(py::module& m)
{
  ...
  py::class_<HDF5RawDataFile>(m, "_HDF5RawDataFile")
    ...
    .def("get_file_name", &HDF5RawDataFile::get_file_name, "Get file name")
    .def("get_recorded_size", &HDF5RawDataFile::get_recorded_size, "Get recorded size")
    .def("get_record_type", &HDF5RawDataFile::get_record_type, "Get record type")
    .def("is_trigger_record_type", &HDF5RawDataFile::is_trigger_record_type, "Is record type TriggerRecord")
    .def("is_timeslice_type", &HDF5RawDataFile::is_timeslice_type, "Is record type TimeSlice")
    .def("get_version", &HDF5RawDataFile::get_version, "FileLayout version number")
    ...
    .def("get_all_record_ids", &HDF5RawDataFile::get_all_record_ids, "Get all record/sequence number pairs.")
    .def("get_all_trigger_record_ids",
         &HDF5RawDataFile::get_all_trigger_record_ids,
         "Get all trigger record/sequence number pairs.")
    .def("get_all_timeslice_ids", &HDF5RawDataFile::get_all_timeslice_ids, "Get all timeslice/sequence number pairs.")
    ...
    .def(
      ...
      py::overload_cast<const daqdataformats::timeslice_number_t>(&HDF5RawDataFile::get_timeslice_header_dataset_path),
...
#endif
    .def("get_geo_ids",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_geo_ids),
    ...
    .def("get_source_ids",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_source_ids),
    ...
    .def("get_frag", py::overload_cast<const std::string&>(&HDF5RawDataFile::get_frag_ptr), "Get Fragment from dataset")
    .def("get_frag",
         py::overload_cast<const uint64_t, // NOLINT(build/unsigned)
                           const daqdataformats::sequence_number_t,
                           const daqdataformats::SourceID&>(&HDF5RawDataFile::get_frag_ptr),
         "Get Fragment from record/sequence number and SourceID")
    .def("get_frag",
         py::overload_cast<const HDF5RawDataFile::record_id_t&, const daqdataformats::SourceID&>(
           &HDF5RawDataFile::get_frag_ptr),
    ...
    .def("get_trh",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_trh_ptr),
    ...
    .def("get_tsh",
         py::overload_cast<const std::string&>(&HDF5RawDataFile::get_tsh_ptr),
         "Get TimeSliceHeader from datset")
    .def("get_tsh",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_tsh_ptr),
    ...
    .def("get_trigger_record",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_trigger_record),
    ...
    .def("get_timeslice",
         py::overload_cast<const HDF5RawDataFile::record_id_t&>(&HDF5RawDataFile::get_timeslice),
         "Get TimeSlice object from record id")
    .def("get_timeslice",
         py::overload_cast<const daqdataformats::timeslice_number_t>(&HDF5RawDataFile::get_timeslice),
